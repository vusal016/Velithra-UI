...
import type { DepartmentDto, PositionDto, EmployeeDto, AppUserDto } from "@/lib/types";
...
export default function EditEmployeePage() {
  ...
  const loadData = async () => {
    try {
      setLoading(true);
      const [deptsRes, possRes, usrsRes, employeeRes] = await Promise.all([
      ...
      const poss = possRes.data.data || possRes.data || [];
      const usrs = usrsRes.data.data || usrsRes.data || [];
      ...
      setFormData({
        ...
        dateOfBirth: employee.dateOfBirth ? formatDate(employee.dateOfBirth) : "",
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-300 mt-1">Update employee information</p>
          </div>
        </div>
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <SelectContent className="bg-[#1a2332] border-white/10">
                    ...
                    <SelectItem value="OnLeave" className="text-white hover:bg-white/10">
                      On Leave
                    </SelectItem>
                    <SelectItem value="Terminated" className="text-white hover:bg-white/10">
                      Terminated
                    </SelectItem>
                  </SelectContent>
                </Select>
